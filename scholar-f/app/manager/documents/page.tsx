    ...
    <main className="min-h-screen bg-background">
      <div className="mx-auto max-w-4xl px-4 py-8 space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold">Manager Document Resources</h1>
        ...
        <Card>
          ...
          <CardContent>
            <form className="space-y-3" onSubmit={onSubmit}>
              ...
              />
              <Input
                placeholder="Scholarship ID (required for manager upload)"
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            {myUserId ? (
              <p className="text-xs text-muted-foreground">Filtering documents by your manager account.</p>
            ) : null}
          </CardContent>
        </Card>
      </div>
