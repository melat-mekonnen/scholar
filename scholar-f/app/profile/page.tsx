...
function ProfilePageInner() {
  ...
  return (
    <div className="flex min-h-screen w-full max-w-[100vw] overflow-x-hidden bg-slate-100 text-slate-900 dark:bg-background dark:text-foreground transition-colors duration-200">
      ...
      <div className="flex min-h-0 min-w-0 w-full flex-1 flex-col">
        ...
        <main className="relative mx-auto w-full min-w-0 max-w-6xl space-y-6 overflow-x-hidden p-6">
