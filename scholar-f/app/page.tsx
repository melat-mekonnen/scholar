    ...
    <main className="min-h-screen bg-background">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="flex flex-col items-center text-center border border-border rounded-2xl bg-card shadow-sm hover:shadow-md transition-shadow p-10">
              ...
              <p className="text-base text-muted-foreground leading-relaxed">
                Access thousands of scholarships from one trusted hub instead of
            ...
            <div className="flex flex-col items-center text-center border border-border rounded-2xl bg-card shadow-sm hover:shadow-md transition-shadow p-10">
              ...
              <p className="text-base text-muted-foreground leading-relaxed">
                Get scholarships tailored to your academic profile, field of
            ...
            <div className="flex flex-col items-center text-center border border-border rounded-2xl bg-card shadow-sm hover:shadow-md transition-shadow p-10">
              ...
              <p className="text-base text-muted-foreground leading-relaxed">
                Explore only authentic and verified scholarships — no outdated
                or fake listings.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center border border-border rounded-2xl bg-card shadow-sm hover:shadow-md transition-shadow p-10">
              ...
              <p className="text-base text-muted-foreground leading-relaxed">
                Manage and track your applications in one place with smart
                deadline reminders.
              </p>
            </div>
          </div>
      ...
      <section className="bg-muted/30 py-20">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-center text-sm text-muted-foreground">
            A simple step-by-step flow from creating your profile to tracking
            applications.
          </p>
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <Card className="rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              <CardContent className="p-8 text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Register and add your academic details so we can personalize
                  your experience.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              <CardContent className="p-8 text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Browse verified opportunities tailored to your field, degree
                  level, and interests.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              <CardContent className="p-8 text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Monitor your applications and stay on top of deadlines and
                  updates.
                </p>
              </CardContent>
            </Card>
      ...
      <footer className="border-t bg-card">
        <div className="mx-auto max-w-7xl px-6 py-8 text-center text-sm text-muted-foreground">
          © 2026 Ethiopian Scholarship Portal. Empowering students through
          education.
        </div>
      </footer>
    </main>
