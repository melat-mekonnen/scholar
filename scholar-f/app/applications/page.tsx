...
export default function ApplicationsPage() {
  ...
  async function changeStatus(id: string, status: ApplicationStatus) {
    ...
    toast({
      ...
      description: "Application status saved.",
    });
  }
          ...
          {!loading && sorted.length === 0 ? (
            <Card>
              ...
              <CardContent className="space-y-3">
                <p className="text-sm text-muted-foreground">
                  Start with a scholarship, click Apply, and it will appear here
                  for tracking.
                </p>
                <Button asChild>
                ...
                <CardContent className="space-y-3">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {a.scholarship.country ? (
                      <Badge variant="outline">{a.scholarship.country}</Badge>
                    ) : null}
                    {a.scholarship.deadline ? (
                      <Badge variant="outline">
                        Deadline: {String(a.scholarship.deadline)}
                      </Badge>
                    ) : null}
                  </div>
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    <Select
                      value={a.status}
                      onValueChange={(v) =>
                        void changeStatus(a.id, v as ApplicationStatus)
                      }
                    >
