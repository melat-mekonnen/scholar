        ...
        <main className="mx-auto max-w-4xl space-y-6 p-6">
          <div>
            ...
            <p className="text-muted-foreground mt-1 text-sm">
              Scholarships you bookmarked. Remove the bookmark to take them off
              this list.
            </p>
          </div>
          ...
          {loading ? (
            ...
            <Empty>
              <EmptyHeader>
                ...
                <EmptyDescription>
                  Browse listings and tap the bookmark icon to save
                  opportunities here.
                </EmptyDescription>
              </EmptyHeader>
              <EmptyContent>
          ...
          viewScholarship ? (
            <ScholarshipBookmarkButton
              ...
              onBookmarkedChange={(next) => {
                if (!next) {
                  setResults((prev) =>
                    prev.filter((row) => row.id !== viewScholarship.id),
                  );
                  setTotal((t) => Math.max(0, t - 1));
