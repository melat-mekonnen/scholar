...
/** Scholarship / match result card with hover lift */
...
/** Emerald outline badges (active filters, tags) */
export const emeraldFilterBadge =
  "gap-1 border-emerald-200 bg-emerald-50/80 text-emerald-900 dark:border-emerald-800 dark:bg-emerald-950/50 dark:text-emerald-200"

export const slateFilterBadge =
  "gap-1 border-slate-200 bg-slate-50 text-slate-800 dark:border-border dark:bg-muted dark:text-foreground"

export const tealFilterBadge =
  "gap-1 border-teal-200 bg-teal-50/80 text-teal-900 dark:border-teal-800 dark:bg-teal-950/40 dark:text-teal-200"

/** Outline buttons on emerald surfaces */
export const outlineEmeraldButton =
  "border-emerald-200 text-emerald-800 hover:bg-emerald-50 dark:border-border dark:bg-transparent dark:text-emerald-200 dark:hover:bg-accent"

/** Inactive tab / filter chip */
export const inactiveChipButton =
  "border-emerald-100 bg-white text-slate-600 hover:bg-emerald-50 hover:text-emerald-800 dark:border-border dark:bg-card dark:text-muted-foreground dark:hover:bg-accent dark:hover:text-emerald-200"

export const accentEmerald = "font-semibold text-emerald-700 dark:text-emerald-400"

/** Manager / owner workspace page title strip */
export const workspacePageHeader =
  `rounded-2xl border border-emerald-100/80 border-l-4 border-l-emerald-500 bg-white px-6 py-6 shadow-sm shadow-emerald-900/5 dark:border-border dark:border-l-emerald-500 dark:bg-card dark:shadow-none ${themeTransition}`

export const workspaceCardShell = emeraldCard
