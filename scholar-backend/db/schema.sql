...
CREATE TABLE IF NOT EXISTS scholarships (
  ...
  deadline DATE,
  degree_level TEXT,
  status TEXT NOT NULL DEFAULT 'draft' CHECK (status IN ('draft','pending','verified','rejected','expired')),
  funding_type TEXT,
  field_of_study TEXT,
  amount TEXT,
  description TEXT,
...
-- Community (student peer support); also run: npm run migrate:community
